// === Mathematical Physics - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('mathematical-physics-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('mathematical-physics-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
